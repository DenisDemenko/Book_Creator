...
export interface WriterBookContextState {
  ...
  /** ID активної книги зі студії (для логування використання ШІ) — null, якщо книга не підключена. */
  bookId: string | null;
  /** Модель ШІ, обрана автором у панелі AI Асистента редактора (EditorView) — щоб AI-тренажери «Майстерності» використовували той самий рушій, а не завжди Gemini. */
