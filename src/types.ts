...
export interface Character {
  ...
  /**
   * Готові діалоги (репліки) героя — те, що автор раніше набирав сам, а тепер
   * вставляє за тегом `/character:Ім'я:діалог` (рішення власника 23.09.2026).
   *
   * ЧОМУ ОКРЕМЕ ПОЛЕ, А НЕ `behaviorPatterns`. Поведінковий шаблон описує, ЯК
   * герой тримається («відводить погляд»), а діалог — те, ЩО він каже. Одне
   * без одного не працює: змішування зробило б і наведення, і підбір
   * діалогів непередбачуваними. Якщо це поле порожнє, підбір падає на старі
   * шаблони (`collectDialogueTemplates`) — щоб функція працювала одразу й на
   * книгах, написаних доти.
   */
...
export type UserRole = 
  ...
  | 'site_manager'// Менеджер сайту: лише чат підтримки в адмінпанелі — ні грошей, ні ролей, ні git
