...
interface AuthScreenProps {
  ...
  onClearError: () => void;
  error: string | null;
  /** Чи налаштований Firebase-вхід на сервері (docs/migration-plan.md Фаза G1). */
          ...
          {firebaseEnabled ? (
            <>
              ...
              <button
                ...
                className="w-full flex items-center justify-center gap-2.5 px-5 py-2.5 rounded-xl bg-white hover:bg-slate-100 text-slate-800 font-semibold text-sm transition-colors disabled:opacity-60"
              >
            ...
            >
              <AlertTriangle className="w-4 h-4 shrink-0 mt-0.5" />
              <span>{t('auth.authDisabledNotice')}</span>
            </div>
          )}
