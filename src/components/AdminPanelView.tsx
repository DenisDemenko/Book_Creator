...
/**
 * Черга модерації публікацій у вітрину — адміністраторський блок під
 * «Мостом до вітрини». Погодження курсу одразу публікує його в маркетплейс;
 * решта типів (книга, інструкція, гра) поки що лише погоджується без
 * авто-публікації.
 */
type ModerationRow = {
  id: string;
...
const ModerationPanel: React.FC = () => {
  ...
  return (
    <div className="mt-6 rounded-2xl bg-slate-900/60 border border-white/[0.06] p-5">
