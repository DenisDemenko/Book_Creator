...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    tabs: ['export', 'kdp-format', 'publishing', 'market'],
  },
  {
    id: 'courses',
    numeral: 'IV',
    labelKey: 'groupCourses',
    tabs: ['courses', 'course-studio', 'narration'],
  },
  {
    id: 'training',
    numeral: 'V',
 ...
 *
 * «Ключі API» тут більше немає свідомо: ключі стали платформними (їх вводить
 * лише адміністратор), і за постановкою розділ переїхав в «Адмін панель» —
 * відкривається там модальним вікном вузла «Провайдери ШІ». Лишати дубль у
 * бічному меню означало б два різні входи в одне налаштування.
 */
